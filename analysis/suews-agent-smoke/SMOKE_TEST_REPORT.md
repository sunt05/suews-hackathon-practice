...
uvx --from 'git+https://github.com/UMEP-dev/SUEWS.git#subdirectory=mcp' suews inspect --format json analysis/suews-agent-smoke/sample_config.yml
...
uvx --from 'git+https://github.com/UMEP-dev/SUEWS.git#subdirectory=mcp' suews diagnose --format json analysis/suews-agent-smoke
uvx --from 'git+https://github.com/UMEP-dev/SUEWS.git#subdirectory=mcp' suews summarise --variables Tair,QH,QE,QN --format json analysis/suews-agent-smoke/Output
```

## What Was Created

- Case directory: `analysis/suews-agent-smoke/`
- Initial config: `analysis/suews-agent-smoke/sample_config.yml`
- Validated/updated config: `analysis/suews-agent-smoke/updated_sample_config.yml`
- Forcing file: `analysis/suews-agent-smoke/Kc_2012_data_60.txt`
- Main output: `analysis/suews-agent-smoke/Output/KCL1_2012_SUEWS_60.txt`
- Checkpoint: `analysis/suews-agent-smoke/Output/KCL_SUEWS_checkpoint.json`
